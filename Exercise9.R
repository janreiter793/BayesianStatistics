...
par(mfrow = c(1,3))
asdf <- 50
plot(y = samples_lambda[burnin:asdf,1], x = samples_beta[burnin:asdf],
     main = "lambda_1, beta", xlab = "beta", ylab = "lambda_1",
     type = "l", panel.first = grid())
plot(y = samples_lambda[burnin:asdf,5], x = samples_beta[burnin:asdf],
     main = "lambda_5, beta", xlab = "beta", ylab = "lambda_5",
     type = "l", panel.first = grid())
plot(y = samples_lambda[burnin:asdf,10], x = samples_beta[burnin:asdf],
     main = "lambda_10, beta", xlab = "beta", ylab = "lambda_10",
     type = "l", panel.first = grid())
